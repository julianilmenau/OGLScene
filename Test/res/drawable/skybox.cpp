...
std::array<QVector3D, 8> SkyBox::vertices()
{
...
std::array<SkyBox::Face, 12> SkyBox::indices()
{
...
void SkyBox::initialize(QOpenGLShaderProgram  *program)
{
   ...
   QString subDirPath = "data/skybox/";
...
void SkyBox::draw(QOpenGLFunctions & functions)
{
   draw(GL_TRIANGLES, functions);
}

void SkyBox::draw(const GLenum mode, QOpenGLFunctions & functions)
{
   m_vao.bind();
   m_textures[0]->bind(0);
